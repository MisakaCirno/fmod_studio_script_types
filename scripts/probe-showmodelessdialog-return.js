...
(function () {
    ...
    var description = {
        ...
        windowTitle: 'showModelessDialog Return Probe',
        windowWidth: 360,
        windowHeight: 120,
        items: [
            {
                widgetType: studio.ui.widgetType.Label,
                text: 'Close this window manually after it appears.'
            },
            {
    ...
    console.log('[showModelessDialog probe] opening dialog');
    var result = studio.ui.showModelessDialog(description);
    var summary = summarize(result);
    console.log('[showModelessDialog probe] result summary: ' + JSON.stringify(summary, null, 2));
    return summary;
})();